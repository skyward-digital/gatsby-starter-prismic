...
const Blog = ({ data, pageContext: { currentPage } }) => {
  if (!data) return null
  const { data: document, url, lang } = data.allPrismicBlogList.edges[0].node
  const postsInfo = data.allPrismicBlogPost.pageInfo
  const posts = data.allPrismicBlogPost.edges.map(edge => edge.node)
      ...
      edges {
        node {
          ...
          data {
            ...
            body {
              ... on PrismicBlogListBodyCallToActionCentered {
                id
                slice_type
                primary {
                  title {
              ...
              ... on PrismicBlogListBodyCallToActionSplit {
                id
                slice_type
                primary {
                  title {
            ...
            preFooterSlices {
              ... on PrismicBlogListPreFooterSlicesCustomerLogos {
                slice_type
                items {
                  logo {
                    alt
              ...
              ... on PrismicBlogListPreFooterSlicesFeatureGrid {
                id
                slice_type
                primary {
                  title {
              ...
              ... on PrismicBlogListPreFooterSlicesCallToActionCentered {
                id
                slice_type
                primary {
                  title {
              ...
              ... on PrismicBlogListPreFooterSlicesCallToActionSplit {
                id
                slice_type
                primary {
                  title {
              ...
              ... on PrismicBlogListPreFooterSlicesTestimonial {
                id
                slice_type
                primary {
                  testimonial {
              ...
              ... on PrismicBlogListPreFooterSlicesNewsletter {
                slice_type
                primary {
                  submit_label {
                    raw
